...
import com.bl.main.model.Employee;
...
public class SpringRestClient {
	private static final String GET_EMPLOYEES_ENDPOINT_URL = "http://localhost:8080/home/employees";
	private static final String GET_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/home/employees/{id}";
	private static final String CREATE_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/home/employees";
	private static final String UPDATE_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/home/employees/{id}";
	private static final String DELETE_EMPLOYEE_ENDPOINT_URL = "http://localhost:8080/home/employees/{id}";
	private static RestTemplate restTemplate = new RestTemplate();
	static SpringRestClient springRestClient = new SpringRestClient();
...
public static void main(String[] args) {
	...
	private void getEmployees() {
		...
		ResponseEntity<String> result = restTemplate.exchange(GET_EMPLOYEES_ENDPOINT_URL, HttpMethod.GET, entity,
				String.class	);
		// restTemplate.exchange(GET_EMPLOYEES_ENDPOINT_URL, HttpMethod.GET,
		// entity,String.clas
		// restTemplate.exchange(GET_EMPLOYEES_ENDPOINT_URL, HttpMethod.GET,
		// entity,String.class,);
